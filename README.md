...
View your app in AI Studio: https://ai.studio/apps/drive/1WIFm6EMsuGHHMzg27WbSysWYYsWWYHn1
...
This web repo is configured to deploy only Hosting and Firestore rules/indexes.

- Web deploy (safe): `npm run deploy:web`
